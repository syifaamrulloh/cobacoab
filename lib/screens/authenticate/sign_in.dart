          ...
          child: Form(
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                validator: (val) => val.isEmpty ? 'Masukan Email anda': null,
                onChanged: (val) {
                  setState(() => email = val);
                },
              ),
              ...
              TextFormField(
                ...
                obscureText: true,
                validator: (val) => val.length < 6 ? 'Masukan 6 digit atau lebih Password anda': null,
                onChanged: (val) {
              ...
              RaisedButton(
                  ...
                  onPressed: () async {
                    if (_formKey.currentState.validate()) {
                      ...
                      if (result == null) {
                        setState(() => 
                        error = 'Mohon maaf Email dan Password yang anda masukan salah');
                        loading = false;
                      }
                    }
                  }),
